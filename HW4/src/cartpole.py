...
class Agent:
    def __init__(self, env, epsilon=0.05, learning_rate=0.5, GAMMA=0.97, num_bins=7):
        ...
        self.qtable = np.zeros(
            (self.num_bins, self.num_bins, self.num_bins, self.num_bins, self.env.action_space.n)
        )
    ...
    def discretize_observation(self, observation):
        ...
        # Begin your code
        """
        Discretize the continuous observation. Using the function "discretize_value()" to get the discretized data of the 4 features in observation.
        """
    ...
    def check_max_Q(self):
        ...
        # Begin your code
        """
        Return the max Q-value of given state, and before returning the max Q-value, the initial state should be discretized first.
        """
